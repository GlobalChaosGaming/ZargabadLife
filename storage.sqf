...
buttonSetAction [3,   format['
	...
	{
		["nehmen",  "%1", ctrlText 2, (lbData [1, (lbCurSel 1)]),"%3", %2] execVM "addstorage.sqf";
		ctrlEnable [3, false];
		ctrlEnable [103, false];
		ctrlEnable [500, false];
		ctrlEnable [501, false];
	};', _arrname, _extra, _public]];

buttonSetAction [103, format['
	if ((lbCurSel 101) >= 0) then
	{
		["ablegen", "%1", ctrlText 102, (lbData [101, (lbCurSel 101)]), "%3", %2] execVM "addstorage.sqf";
		ctrlEnable [3, false];
		ctrlEnable [103, false];
		ctrlEnable [500, false];
		ctrlEnable [501, false];
