...
// Heal
if (_option == 5 && alive player) exitWith {
...
// Check Inventory
if (_option == 6 && alive player) exitWith {
...
// Steal Money
if (_option == 20 && alive player) exitWith {
...
// Arrest
if (_option == 3 && alive player) exitWith {
...
// Ticket
if (_option == 4 && alive player) exitWith {
