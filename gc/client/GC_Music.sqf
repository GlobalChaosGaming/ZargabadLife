...
radio_handle = [_trackList,_durationList,0,_radio] spawn {
	private ["_ran","_fade","_mod","_fadeamt","_dist","_n","_track","_durationFull","_oldRan","_duration","_lvl","_trackList","_trackCount","_durationList","_delay","_radio","_fadeTime","_newaction"];
