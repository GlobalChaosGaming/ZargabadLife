...
switch (_option) do {
  ...
  case "joseph": {
    "Father Joseph" hintC format["%1, Dont you love these new cops?  They took all my rape whistles", name player];
    sleep 0.1;
    hint "";
  };
};
...
if (_cash < 500) exitwith {
	player groupchat "I had a rape whistle earlier but some fat woman offered me $500 for it!";
};
...
['cash', -(500)] call INV_AddInventoreItem;
