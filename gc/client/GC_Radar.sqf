...
_veh setvariable ["radartarget","<t shadow='1' shadowColor='#cc0000' size='1' font='Zeppelin33' align='center' valign='top'>Initializing...</t>",false];
		...
		if (driver _veh == player) then {
			...
			if (!isNull driver _tag) then {
				...
				if (_tagfast > 1) then {
					...
					_veh setvariable ["radartarget",format["<t shadow='1' shadowColor='#cc0000' size='1' font='Zeppelin33' align='center' valign='top'>%1</t>",name driver _tag],false];
					_updated = 1;
				} else {
