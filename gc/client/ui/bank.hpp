class bank {
    ...
    objects[] = {};
    controls[] = {header, text1, spielerliste, text2, transfer_eingabe, text4, money_steuern, submit, text5, withdraw_eingabe, withdraw_submit, cancel, trennlinie, text_inventarmoney, text_accountmoney, dummybutton };
