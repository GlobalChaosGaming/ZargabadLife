class AdminMenu
{
	...
	class AdminMenu_background:RscBackgroundPicture
	{
		idc=-1;
		x=0.288888888888889;
		y=0.106666666666667;
...
class wantedrelease
{
	...
	objects[] = { };
	controls[] = {civlist, kopfcash_eingabe, cost, header1, submit, header2, cancel, civlist2, submit2, set_unwanted, dummybutton};
...
class liste_1_button
{
	...
	objects[] = { };
	controls[] = {header, spielerliste, close, dummybutton};
...
class MainCamDialog
{
	...
	class DLG_BACK2: RscBackgroundPicture
	{
		x = -1.00;
		y = 0.80;
		w =  3.00;
	...
	class DLG_BACK3: RscBackgroundPicture
	{
		x = -1.00;
		y = -1.00;
		w =  1.10;
	...
	class DLG_BACK4: RscBackgroundPicture
	{
		x = 0.90;
		y = -1.00;
		w = 1.10;
...
controlsBackground[] = {DLG_BACK1, background};
objects[] = { };
controls[] = {firstbutton, secondbutton, thirdbutton, fourthbutton, closebutton};
