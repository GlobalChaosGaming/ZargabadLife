...

{
	...
	if(_facName == "factory4") then {
		_index = lbAdd [1, format["%1 ($%2, %3 mins)", (_x call INV_getitemName), (_x call INV_getitemBuyCost)*0.5, round((_eta/2)/60)]];
	} else {
