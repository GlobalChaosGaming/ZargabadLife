...
if(_stock >= _maxstock)exitwith{player groupchat "The shop has reached its maximum stock for this ammunition.";fvspam=false;};

["SKILL_EXPORT",0.025] call GC_addSkill;
['cash', _preis] call INV_AddInventoreItem;

player groupchat format["The ammunition has been exported for $%1!", _preis];
