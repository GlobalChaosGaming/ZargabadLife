...
ctrlSetText [202, format ["%1/%2kg", (_array call INV_getitemTypeKg), (((_array call INV_getitemTypeKg)*(_anzahl)) call ISSE_str_IntToStr)]];
CtrlSetText [64, format ["Capacity: %1/%2kg", (call INV_GetOwnWeight), INV_Tragfaehigkeit]];
