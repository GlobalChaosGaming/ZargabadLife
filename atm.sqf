...
//if (isNil "kontostand") then {kontostand = 100000};
...
CtrlSetText [101, format [localize "STRS_bank_dialog_inventarcash", (_cash call ISSE_str_IntToStr)]];
CtrlSetText [102, format [localize "STRS_bank_dialoge_accountcash",  (Kontostand call ISSE_str_IntToStr)]];
