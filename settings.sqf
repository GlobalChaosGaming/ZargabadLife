...
if (_art == "GrafikEinstellungen") then {["closedialog 0; [""Einstellungen""] execVM ""settings.sqf"";"] execVM "gfxbutton.sqf";};
...
if (_art == "ItemList") then {
  _handler = ["closedialog 0; [""Einstellungen""] execVM ""settings.sqf"";", "Back"] execVM "gc\client\ui\itemlist.sqf";
