...
if(_cash < MGcost)exitwith{player groupchat "not enough money"};

['cash', -MGcost] call INV_AddInventoreItem;
...
if(_cash < PKcost)exitwith{player groupchat "not enough money"};

['cash', -PKcost] call INV_AddInventoreItem;
