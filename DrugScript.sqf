...
if (_art == "Harvest") then
{
	...
	if (_type == "Marijuana") then
	{
		...
		['Unprocessed_Marijuana', +(1)] call INV_AddInventoreItem;
		['MarijuanaSeed', +(2)] call INV_AddInventoreItem;
	...
	if (_type == "Cocaine") then
	{
		...
		['CocaineUP', +(1)] call INV_AddInventoreItem;
		['CocaineSeed', +(2)] call INV_AddInventoreItem;
	...
	if (_type == "Olive") then
	{
		...
		['Olives', +(1)] call INV_AddInventoreItem;
		['OliveSeed', +(2)] call INV_AddInventoreItem;
...
if (_art == "Process") then
{
	...
	if (_type == "Marijuana") then
	{
		...
		if (_Ammount > 0) then
		{
			...
			['MarijuanaUP', -(1)] call INV_AddInventoreItem;
			['marihuana', +(1)] call INV_AddInventoreItem;
		}
		else
		{
	...
	if (_type == "Cocaine") then
	{
		...
		if (_Ammount > 0) then
		{
			...
			['CocaineUP', -(1)] call INV_AddInventoreItem;
			['kokain', +(1)] call INV_AddInventoreItem;
		}
		else
		{
